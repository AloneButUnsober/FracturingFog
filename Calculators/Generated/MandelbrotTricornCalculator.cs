...
// Generated: 2026-06-01 23:01:11 UTC
//
    ...
    private void IterateLaneAvx2(Vector256<double> cr, Vector256<double> ci, uint[] buf, int idx)
    {
        ...
        for (int n = 0; n < maxIt; n++)
        {
            ...
            itCounts = Avx2.Add(itCounts, Avx2.And(oneL, activeMaskL));
                ...
                Vector256<double> z_re3 = Avx.Subtract(Vector256<double>.Zero, z_im2);
                Vector256<double> z_re4 = Avx.Add(z_re1, cr);
                Vector256<double> z_im5 = Avx.Add(z_re3, ci);
                Vector256<double> zr_new = z_re4;
                Vector256<double> zi_new = z_im5;
