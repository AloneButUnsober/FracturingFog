...
// Generated: 2026-06-01 18:15:20 UTC
//
...
public sealed class MandelbrotZ4Calculator : IFractalCalculator, IDisposable
{
    ...
    private void IteratePixelScalar(double cr, double ci, uint[] buf, int idx)
    {
        ...
        for (; it < maxIt; it++)
        {
            ...
            double dr_new = (((4.0 * ((zr * zr - zi * zi) * zr - (zr * zi + zi * zr) * zi)) * dr - (4.0 * ((zr * zr - zi * zi) * zi + (zr * zi + zi * zr) * zr)) * di) + 1.0);
            double di_new = ((4.0 * ((zr * zr - zi * zi) * zr - (zr * zi + zi * zr) * zi)) * di + (4.0 * ((zr * zr - zi * zi) * zi + (zr * zi + zi * zr) * zr)) * dr);
    ...
    private void IterateLaneAvx2(Vector256<double> cr, Vector256<double> ci, uint[] buf, int idx)
    {
        ...
        for (int n = 0; n < maxIt; n++)
        {
            ...
            itCounts = Avx2.Add(itCounts, Avx2.And(oneL, activeMaskL));
                ...
                Vector256<double> d_re1 = Vector256.Create(4.0);
                ...
                Vector256<double> d_re6 = Avx.Multiply(d_re1, d_re4);
                Vector256<double> d_im7 = Avx.Multiply(d_re1, d_im5);
                Vector256<double> d_re8 = Fma.MultiplyAddNegated(d_im7, di, Avx.Multiply(d_re6, dr));
                Vector256<double> d_im9 = Fma.MultiplyAdd(d_re6, di, Avx.Multiply(d_im7, dr));
                Vector256<double> d_re10 = Vector256.Create(1.0);
                Vector256<double> d_re11 = Avx.Add(d_re8, d_re10);
                Vector256<double> dr_new = d_re11;
                Vector256<double> di_new = d_im9;
    ...
    //                 =  ε + 4*z^3*δ + 0.5*4*3*z^2*δ*δ + 0.16666666666666666*4*3*2*z*δ*δ*δ + δ*δ*δ*δ
    //
        ...
        if (useExtendedRef)
        {
            ...
            for (n = 0; n < maxIt; n++)
            {
                ...
                if (UseBla)
                {
                    ...
                    double cr = Cr, ci = Ci;
                    double Ar_new = (4.0 * ((zr * zr - zi * zi) * zr - (zr * zi + zi * zr) * zi));
                    double Ai_new = (4.0 * ((zr * zr - zi * zi) * zi + (zr * zi + zi * zr) * zr));
                    double Br_new = 1.0;
                    double Bi_new = 0.0;
            ...
            if (useSimdLane)
            {
                ...
                for (; x + 8 <= Width; x += 8)
                {
                    ...
                    for (int it = 0; it < refOrbitLen; it++)
                    {
                        ...
                        // Derivative
                        {
                    Vector512<double> dvre1 = Vector512.Create(4.0);
                    ...
                    Vector512<double> dvre6 = Avx512F.Multiply(dvre1, dvre4);
                    Vector512<double> dvim7 = Avx512F.Multiply(dvre1, dvim5);
                    Vector512<double> dvre8 = Avx512F.FusedMultiplyAddNegated(dvim7, div, Avx512F.Multiply(dvre6, drv));
                    Vector512<double> dvim9 = Avx512F.FusedMultiplyAdd(dvre6, div, Avx512F.Multiply(dvim7, drv));
                    Vector512<double> dvre10 = Vector512.Create(1.0);
                    Vector512<double> dvre11 = Avx512F.Add(dvre8, dvre10);
                    Vector512<double> drv_new = dvre11;
                    Vector512<double> div_new = dvim9;
                        ...
                        // δ
                        {
                    Vector512<double> pre1 = Vector512.Create(4.0);
                    ...
                    Vector512<double> pre6 = Avx512F.Multiply(pre1, pre4);
                    Vector512<double> pim7 = Avx512F.Multiply(pre1, pim5);
                    Vector512<double> pre8 = Avx512F.FusedMultiplyAddNegated(pim7, di, Avx512F.Multiply(pre6, dr));
                    Vector512<double> pim9 = Avx512F.FusedMultiplyAdd(pre6, di, Avx512F.Multiply(pim7, dr));
                    Vector512<double> pre10 = Avx512F.Add(er_v, pre8);
                    Vector512<double> pim11 = Avx512F.Add(ei_v, pim9);
                    Vector512<double> pre12 = Vector512.Create(0.5);
                    Vector512<double> pre13 = Vector512.Create(4.0);
                    Vector512<double> pre14 = Vector512.Create(3.0);
                    Vector512<double> pre15 = Avx512F.FusedMultiplyAddNegated(Zi_v, Zi_v, Avx512F.Multiply(Zr_v, Zr_v));
                    Vector512<double> pim16 = Avx512F.FusedMultiplyAdd(Zr_v, Zi_v, Avx512F.Multiply(Zi_v, Zr_v));
                    Vector512<double> pre17 = Avx512F.Multiply(pre14, pre15);
                    Vector512<double> pim18 = Avx512F.Multiply(pre14, pim16);
                    Vector512<double> pre19 = Avx512F.Multiply(pre13, pre17);
                    Vector512<double> pim20 = Avx512F.Multiply(pre13, pim18);
                    Vector512<double> pre21 = Avx512F.Multiply(pre12, pre19);
                    Vector512<double> pim22 = Avx512F.Multiply(pre12, pim20);
                    Vector512<double> pre23 = Avx512F.FusedMultiplyAddNegated(pim22, di, Avx512F.Multiply(pre21, dr));
                    Vector512<double> pim24 = Avx512F.FusedMultiplyAdd(pre21, di, Avx512F.Multiply(pim22, dr));
                    ...
                    Vector512<double> pre27 = Avx512F.Add(pre10, pre25);
                    Vector512<double> pim28 = Avx512F.Add(pim11, pim26);
                    Vector512<double> pre29 = Vector512.Create(0.16666666666666666);
                    Vector512<double> pre30 = Vector512.Create(4.0);
                    Vector512<double> pre31 = Vector512.Create(3.0);
                    ...
                    Vector512<double> pre35 = Avx512F.Multiply(pre31, pre33);
                    Vector512<double> pim36 = Avx512F.Multiply(pre31, pim34);
                    Vector512<double> pre37 = Avx512F.Multiply(pre30, pre35);
                    Vector512<double> pim38 = Avx512F.Multiply(pre30, pim36);
                    Vector512<double> pre39 = Avx512F.Multiply(pre29, pre37);
                    Vector512<double> pim40 = Avx512F.Multiply(pre29, pim38);
                    Vector512<double> pre41 = Avx512F.FusedMultiplyAddNegated(pim40, di, Avx512F.Multiply(pre39, dr));
                    Vector512<double> pim42 = Avx512F.FusedMultiplyAdd(pre39, di, Avx512F.Multiply(pim40, dr));
                    Vector512<double> pre43 = Avx512F.FusedMultiplyAddNegated(pim42, di, Avx512F.Multiply(pre41, dr));
                    Vector512<double> pim44 = Avx512F.FusedMultiplyAdd(pre41, di, Avx512F.Multiply(pim42, dr));
                    Vector512<double> pre45 = Avx512F.FusedMultiplyAddNegated(pim44, di, Avx512F.Multiply(pre43, dr));
                    Vector512<double> pim46 = Avx512F.FusedMultiplyAdd(pre43, di, Avx512F.Multiply(pim44, dr));
                    Vector512<double> pre47 = Avx512F.Add(pre27, pre45);
                    Vector512<double> pim48 = Avx512F.Add(pim28, pim46);
                    Vector512<double> pre49 = Avx512F.FusedMultiplyAddNegated(di, di, Avx512F.Multiply(dr, dr));
                    Vector512<double> pim50 = Avx512F.FusedMultiplyAdd(dr, di, Avx512F.Multiply(di, dr));
                    ...
                    Vector512<double> pre53 = Avx512F.FusedMultiplyAddNegated(pim52, di, Avx512F.Multiply(pre51, dr));
                    Vector512<double> pim54 = Avx512F.FusedMultiplyAdd(pre51, di, Avx512F.Multiply(pim52, dr));
                    Vector512<double> pre55 = Avx512F.Add(pre47, pre53);
                    Vector512<double> pim56 = Avx512F.Add(pim48, pim54);
                    Vector512<double> dr_new = pre55;
                    Vector512<double> di_new = pim56;
                            Vector512<double> keep = activeMask.AsDouble();
            ...
            for (; x < Width; x++)
            {
                ...
                double dr = 0.0, di = 0.0;     // δ
                {
                    ...
                    for (; it < refOrbitLen; it++)
                    {
                        ...
                        {
                    double drv_new = (((4.0 * ((zr * zr - zi * zi) * zr - (zr * zi + zi * zr) * zi)) * drv - (4.0 * ((zr * zr - zi * zi) * zi + (zr * zi + zi * zr) * zr)) * div) + 1.0);
                    double div_new = ((4.0 * ((zr * zr - zi * zi) * zr - (zr * zi + zi * zr) * zi)) * div + (4.0 * ((zr * zr - zi * zi) * zi + (zr * zi + zi * zr) * zr)) * drv);
                    ...
                    double dr_new = ((((er + ((4.0 * ((Zr * Zr - Zi * Zi) * Zr - (Zr * Zi + Zi * Zr) * Zi)) * dr - (4.0 * ((Zr * Zr - Zi * Zi) * Zi + (Zr * Zi + Zi * Zr) * Zr)) * di)) + (((0.5 * (4.0 * (3.0 * (Zr * Zr - Zi * Zi)))) * dr - (0.5 * (4.0 * (3.0 * (Zr * Zi + Zi * Zr)))) * di) * dr - ((0.5 * (4.0 * (3.0 * (Zr * Zr - Zi * Zi)))) * di + (0.5 * (4.0 * (3.0 * (Zr * Zi + Zi * Zr)))) * dr) * di)) + ((((0.16666666666666666 * (4.0 * (3.0 * (2.0 * Zr)))) * dr - (0.16666666666666666 * (4.0 * (3.0 * (2.0 * Zi)))) * di) * dr - ((0.16666666666666666 * (4.0 * (3.0 * (2.0 * Zr)))) * di + (0.16666666666666666 * (4.0 * (3.0 * (2.0 * Zi)))) * dr) * di) * dr - (((0.16666666666666666 * (4.0 * (3.0 * (2.0 * Zr)))) * dr - (0.16666666666666666 * (4.0 * (3.0 * (2.0 * Zi)))) * di) * di + ((0.16666666666666666 * (4.0 * (3.0 * (2.0 * Zr)))) * di + (0.16666666666666666 * (4.0 * (3.0 * (2.0 * Zi)))) * dr) * dr) * di)) + (((dr * dr - di * di) * dr - (dr * di + di * dr) * di) * dr - ((dr * dr - di * di) * di + (dr * di + di * dr) * dr) * di));
                    double di_new = ((((ei + ((4.0 * ((Zr * Zr - Zi * Zi) * Zr - (Zr * Zi + Zi * Zr) * Zi)) * di + (4.0 * ((Zr * Zr - Zi * Zi) * Zi + (Zr * Zi + Zi * Zr) * Zr)) * dr)) + (((0.5 * (4.0 * (3.0 * (Zr * Zr - Zi * Zi)))) * dr - (0.5 * (4.0 * (3.0 * (Zr * Zi + Zi * Zr)))) * di) * di + ((0.5 * (4.0 * (3.0 * (Zr * Zr - Zi * Zi)))) * di + (0.5 * (4.0 * (3.0 * (Zr * Zi + Zi * Zr)))) * dr) * dr)) + ((((0.16666666666666666 * (4.0 * (3.0 * (2.0 * Zr)))) * dr - (0.16666666666666666 * (4.0 * (3.0 * (2.0 * Zi)))) * di) * dr - ((0.16666666666666666 * (4.0 * (3.0 * (2.0 * Zr)))) * di + (0.16666666666666666 * (4.0 * (3.0 * (2.0 * Zi)))) * dr) * di) * di + (((0.16666666666666666 * (4.0 * (3.0 * (2.0 * Zr)))) * dr - (0.16666666666666666 * (4.0 * (3.0 * (2.0 * Zi)))) * di) * di + ((0.16666666666666666 * (4.0 * (3.0 * (2.0 * Zr)))) * di + (0.16666666666666666 * (4.0 * (3.0 * (2.0 * Zi)))) * dr) * dr) * dr)) + (((dr * dr - di * di) * dr - (dr * di + di * dr) * di) * di + ((dr * dr - di * di) * di + (dr * di + di * dr) * dr) * dr));
                        dr = dr_new; di = di_new;
                    }
