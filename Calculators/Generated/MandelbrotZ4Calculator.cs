...
// Generated: 2026-06-01 23:11:12 UTC
//
...
public sealed class MandelbrotZ4Calculator : IFractalCalculator, IDisposable
{
    ...
    //                 =  ε + (((z + z)*z + z*z)*z + z*z*z)*δ + 0.5*((2*z + z + z + z + z)*z + (z + z)*z + z*z + (z + z)*z + z*z)*δ*δ + 0.16666666666666666*(6*z + 2*z + z + z + z + z + 2*z + z + z + z + z + 2*z + z + z + z + z)*δ*δ*δ + δ*δ*δ*δ
    //
        ...
        Parallel.For(0, Height, new ParallelOptions { CancellationToken = ct }, y =>
        {
            ...
            if (useSimdLane)
            {
                ...
                for (; x + 8 <= Width; x += 8)
                {
                    ...
                    Vector512<double> pre19 = Avx512F.Add(er_v, pre17);
                    Vector512<double> pim20 = Avx512F.Add(ei_v, pim18);
                    Vector512<double> pre21 = Vector512.Create(0.5);
                    Vector512<double> pre22 = Vector512.Create(2.0);
                    Vector512<double> pre23 = Avx512F.Multiply(pre22, Zr_v);
                    Vector512<double> pim24 = Avx512F.Multiply(pre22, Zi_v);
                    Vector512<double> pre25 = Avx512F.Add(Zr_v, Zr_v);
                    Vector512<double> pim26 = Avx512F.Add(Zi_v, Zi_v);
                    Vector512<double> pre27 = Avx512F.Add(pre23, pre25);
                    Vector512<double> pim28 = Avx512F.Add(pim24, pim26);
                    Vector512<double> pre29 = Avx512F.Add(Zr_v, Zr_v);
                    Vector512<double> pim30 = Avx512F.Add(Zi_v, Zi_v);
                    Vector512<double> pre31 = Avx512F.Add(pre27, pre29);
                    Vector512<double> pim32 = Avx512F.Add(pim28, pim30);
                    Vector512<double> pre33 = Avx512F.FusedMultiplyAddNegated(pim32, Zi_v, Avx512F.Multiply(pre31, Zr_v));
                    Vector512<double> pim34 = Avx512F.FusedMultiplyAdd(pre31, Zi_v, Avx512F.Multiply(pim32, Zr_v));
                    Vector512<double> pre35 = Avx512F.Add(Zr_v, Zr_v);
                    Vector512<double> pim36 = Avx512F.Add(Zi_v, Zi_v);
                    Vector512<double> pre37 = Avx512F.FusedMultiplyAddNegated(pim36, Zi_v, Avx512F.Multiply(pre35, Zr_v));
                    Vector512<double> pim38 = Avx512F.FusedMultiplyAdd(pre35, Zi_v, Avx512F.Multiply(pim36, Zr_v));
                    Vector512<double> pre39 = Avx512F.FusedMultiplyAddNegated(Zi_v, Zi_v, Avx512F.Multiply(Zr_v, Zr_v));
                    Vector512<double> pim40 = Avx512F.FusedMultiplyAdd(Zr_v, Zi_v, Avx512F.Multiply(Zi_v, Zr_v));
                    Vector512<double> pre41 = Avx512F.Add(pre37, pre39);
                    Vector512<double> pim42 = Avx512F.Add(pim38, pim40);
                    Vector512<double> pre43 = Avx512F.Add(pre33, pre41);
                    Vector512<double> pim44 = Avx512F.Add(pim34, pim42);
                    ...
                    Vector512<double> pre55 = Avx512F.Multiply(pre21, pre53);
                    Vector512<double> pim56 = Avx512F.Multiply(pre21, pim54);
                    ...
                    Vector512<double> pre59 = Avx512F.FusedMultiplyAddNegated(pim58, di, Avx512F.Multiply(pre57, dr));
                    Vector512<double> pim60 = Avx512F.FusedMultiplyAdd(pre57, di, Avx512F.Multiply(pim58, dr));
                    Vector512<double> pre61 = Avx512F.Add(pre19, pre59);
                    Vector512<double> pim62 = Avx512F.Add(pim20, pim60);
                    Vector512<double> pre63 = Vector512.Create(0.16666666666666666);
                    Vector512<double> pre64 = Vector512.Create(6.0);
                    Vector512<double> pre65 = Avx512F.Multiply(pre64, Zr_v);
                    Vector512<double> pim66 = Avx512F.Multiply(pre64, Zi_v);
                    Vector512<double> pre67 = Vector512.Create(2.0);
                    Vector512<double> pre68 = Avx512F.Multiply(pre67, Zr_v);
                    Vector512<double> pim69 = Avx512F.Multiply(pre67, Zi_v);
                    Vector512<double> pre70 = Avx512F.Add(Zr_v, Zr_v);
                    Vector512<double> pim71 = Avx512F.Add(Zi_v, Zi_v);
                    Vector512<double> pre72 = Avx512F.Add(pre68, pre70);
                    Vector512<double> pim73 = Avx512F.Add(pim69, pim71);
                    Vector512<double> pre74 = Avx512F.Add(Zr_v, Zr_v);
                    Vector512<double> pim75 = Avx512F.Add(Zi_v, Zi_v);
                    Vector512<double> pre76 = Avx512F.Add(pre72, pre74);
                    Vector512<double> pim77 = Avx512F.Add(pim73, pim75);
                    Vector512<double> pre78 = Avx512F.Add(pre65, pre76);
                    Vector512<double> pim79 = Avx512F.Add(pim66, pim77);
                    Vector512<double> pre80 = Vector512.Create(2.0);
                    Vector512<double> pre81 = Avx512F.Multiply(pre80, Zr_v);
                    Vector512<double> pim82 = Avx512F.Multiply(pre80, Zi_v);
                    Vector512<double> pre83 = Avx512F.Add(Zr_v, Zr_v);
                    Vector512<double> pim84 = Avx512F.Add(Zi_v, Zi_v);
                    Vector512<double> pre85 = Avx512F.Add(pre81, pre83);
                    Vector512<double> pim86 = Avx512F.Add(pim82, pim84);
                    Vector512<double> pre87 = Avx512F.Add(Zr_v, Zr_v);
                    Vector512<double> pim88 = Avx512F.Add(Zi_v, Zi_v);
                    Vector512<double> pre89 = Avx512F.Add(pre85, pre87);
                    Vector512<double> pim90 = Avx512F.Add(pim86, pim88);
                    Vector512<double> pre91 = Avx512F.Add(pre78, pre89);
                    Vector512<double> pim92 = Avx512F.Add(pim79, pim90);
                    Vector512<double> pre93 = Vector512.Create(2.0);
                    Vector512<double> pre94 = Avx512F.Multiply(pre93, Zr_v);
                    Vector512<double> pim95 = Avx512F.Multiply(pre93, Zi_v);
                    Vector512<double> pre96 = Avx512F.Add(Zr_v, Zr_v);
                    Vector512<double> pim97 = Avx512F.Add(Zi_v, Zi_v);
                    Vector512<double> pre98 = Avx512F.Add(pre94, pre96);
                    Vector512<double> pim99 = Avx512F.Add(pim95, pim97);
                    Vector512<double> pre100 = Avx512F.Add(Zr_v, Zr_v);
                    Vector512<double> pim101 = Avx512F.Add(Zi_v, Zi_v);
                    Vector512<double> pre102 = Avx512F.Add(pre98, pre100);
                    Vector512<double> pim103 = Avx512F.Add(pim99, pim101);
                    Vector512<double> pre104 = Avx512F.Add(pre91, pre102);
                    Vector512<double> pim105 = Avx512F.Add(pim92, pim103);
                    Vector512<double> pre106 = Avx512F.Multiply(pre63, pre104);
                    Vector512<double> pim107 = Avx512F.Multiply(pre63, pim105);
                    ...
                    Vector512<double> pre112 = Avx512F.FusedMultiplyAddNegated(pim111, di, Avx512F.Multiply(pre110, dr));
                    Vector512<double> pim113 = Avx512F.FusedMultiplyAdd(pre110, di, Avx512F.Multiply(pim111, dr));
                    Vector512<double> pre114 = Avx512F.Add(pre61, pre112);
                    Vector512<double> pim115 = Avx512F.Add(pim62, pim113);
                    Vector512<double> pre116 = Avx512F.FusedMultiplyAddNegated(di, di, Avx512F.Multiply(dr, dr));
                    Vector512<double> pim117 = Avx512F.FusedMultiplyAdd(dr, di, Avx512F.Multiply(di, dr));
                    ...
                    Vector512<double> pre120 = Avx512F.FusedMultiplyAddNegated(pim119, di, Avx512F.Multiply(pre118, dr));
                    Vector512<double> pim121 = Avx512F.FusedMultiplyAdd(pre118, di, Avx512F.Multiply(pim119, dr));
                    Vector512<double> pre122 = Avx512F.Add(pre114, pre120);
                    Vector512<double> pim123 = Avx512F.Add(pim115, pim121);
            ...
            for (; x < Width; x++)
            {
                ...
                double dr = 0.0, di = 0.0;     // δ
                {
                    ...
                    double dr_new = ((((er + ((((((Zr + Zr) * Zr - (Zi + Zi) * Zi) + (Zr * Zr - Zi * Zi)) * Zr - (((Zr + Zr) * Zi + (Zi + Zi) * Zr) + (Zr * Zi + Zi * Zr)) * Zi) + ((Zr * Zr - Zi * Zi) * Zr - (Zr * Zi + Zi * Zr) * Zi)) * dr - (((((Zr + Zr) * Zr - (Zi + Zi) * Zi) + (Zr * Zr - Zi * Zi)) * Zi + (((Zr + Zr) * Zi + (Zi + Zi) * Zr) + (Zr * Zi + Zi * Zr)) * Zr) + ((Zr * Zr - Zi * Zi) * Zi + (Zr * Zi + Zi * Zr) * Zr)) * di)) + (((0.5 * ((((((2.0 * Zr) + (Zr + Zr)) + (Zr + Zr)) * Zr - (((2.0 * Zi) + (Zi + Zi)) + (Zi + Zi)) * Zi) + (((Zr + Zr) * Zr - (Zi + Zi) * Zi) + (Zr * Zr - Zi * Zi))) + (((Zr + Zr) * Zr - (Zi + Zi) * Zi) + (Zr * Zr - Zi * Zi)))) * dr - (0.5 * ((((((2.0 * Zr) + (Zr + Zr)) + (Zr + Zr)) * Zi + (((2.0 * Zi) + (Zi + Zi)) + (Zi + Zi)) * Zr) + (((Zr + Zr) * Zi + (Zi + Zi) * Zr) + (Zr * Zi + Zi * Zr))) + (((Zr + Zr) * Zi + (Zi + Zi) * Zr) + (Zr * Zi + Zi * Zr)))) * di) * dr - ((0.5 * ((((((2.0 * Zr) + (Zr + Zr)) + (Zr + Zr)) * Zr - (((2.0 * Zi) + (Zi + Zi)) + (Zi + Zi)) * Zi) + (((Zr + Zr) * Zr - (Zi + Zi) * Zi) + (Zr * Zr - Zi * Zi))) + (((Zr + Zr) * Zr - (Zi + Zi) * Zi) + (Zr * Zr - Zi * Zi)))) * di + (0.5 * ((((((2.0 * Zr) + (Zr + Zr)) + (Zr + Zr)) * Zi + (((2.0 * Zi) + (Zi + Zi)) + (Zi + Zi)) * Zr) + (((Zr + Zr) * Zi + (Zi + Zi) * Zr) + (Zr * Zi + Zi * Zr))) + (((Zr + Zr) * Zi + (Zi + Zi) * Zr) + (Zr * Zi + Zi * Zr)))) * dr) * di)) + ((((0.16666666666666666 * ((((6.0 * Zr) + (((2.0 * Zr) + (Zr + Zr)) + (Zr + Zr))) + (((2.0 * Zr) + (Zr + Zr)) + (Zr + Zr))) + (((2.0 * Zr) + (Zr + Zr)) + (Zr + Zr)))) * dr - (0.16666666666666666 * ((((6.0 * Zi) + (((2.0 * Zi) + (Zi + Zi)) + (Zi + Zi))) + (((2.0 * Zi) + (Zi + Zi)) + (Zi + Zi))) + (((2.0 * Zi) + (Zi + Zi)) + (Zi + Zi)))) * di) * dr - ((0.16666666666666666 * ((((6.0 * Zr) + (((2.0 * Zr) + (Zr + Zr)) + (Zr + Zr))) + (((2.0 * Zr) + (Zr + Zr)) + (Zr + Zr))) + (((2.0 * Zr) + (Zr + Zr)) + (Zr + Zr)))) * di + (0.16666666666666666 * ((((6.0 * Zi) + (((2.0 * Zi) + (Zi + Zi)) + (Zi + Zi))) + (((2.0 * Zi) + (Zi + Zi)) + (Zi + Zi))) + (((2.0 * Zi) + (Zi + Zi)) + (Zi + Zi)))) * dr) * di) * dr - (((0.16666666666666666 * ((((6.0 * Zr) + (((2.0 * Zr) + (Zr + Zr)) + (Zr + Zr))) + (((2.0 * Zr) + (Zr + Zr)) + (Zr + Zr))) + (((2.0 * Zr) + (Zr + Zr)) + (Zr + Zr)))) * dr - (0.16666666666666666 * ((((6.0 * Zi) + (((2.0 * Zi) + (Zi + Zi)) + (Zi + Zi))) + (((2.0 * Zi) + (Zi + Zi)) + (Zi + Zi))) + (((2.0 * Zi) + (Zi + Zi)) + (Zi + Zi)))) * di) * di + ((0.16666666666666666 * ((((6.0 * Zr) + (((2.0 * Zr) + (Zr + Zr)) + (Zr + Zr))) + (((2.0 * Zr) + (Zr + Zr)) + (Zr + Zr))) + (((2.0 * Zr) + (Zr + Zr)) + (Zr + Zr)))) * di + (0.16666666666666666 * ((((6.0 * Zi) + (((2.0 * Zi) + (Zi + Zi)) + (Zi + Zi))) + (((2.0 * Zi) + (Zi + Zi)) + (Zi + Zi))) + (((2.0 * Zi) + (Zi + Zi)) + (Zi + Zi)))) * dr) * dr) * di)) + (((dr * dr - di * di) * dr - (dr * di + di * dr) * di) * dr - ((dr * dr - di * di) * di + (dr * di + di * dr) * dr) * di));
                    double di_new = ((((ei + ((((((Zr + Zr) * Zr - (Zi + Zi) * Zi) + (Zr * Zr - Zi * Zi)) * Zr - (((Zr + Zr) * Zi + (Zi + Zi) * Zr) + (Zr * Zi + Zi * Zr)) * Zi) + ((Zr * Zr - Zi * Zi) * Zr - (Zr * Zi + Zi * Zr) * Zi)) * di + (((((Zr + Zr) * Zr - (Zi + Zi) * Zi) + (Zr * Zr - Zi * Zi)) * Zi + (((Zr + Zr) * Zi + (Zi + Zi) * Zr) + (Zr * Zi + Zi * Zr)) * Zr) + ((Zr * Zr - Zi * Zi) * Zi + (Zr * Zi + Zi * Zr) * Zr)) * dr)) + (((0.5 * ((((((2.0 * Zr) + (Zr + Zr)) + (Zr + Zr)) * Zr - (((2.0 * Zi) + (Zi + Zi)) + (Zi + Zi)) * Zi) + (((Zr + Zr) * Zr - (Zi + Zi) * Zi) + (Zr * Zr - Zi * Zi))) + (((Zr + Zr) * Zr - (Zi + Zi) * Zi) + (Zr * Zr - Zi * Zi)))) * dr - (0.5 * ((((((2.0 * Zr) + (Zr + Zr)) + (Zr + Zr)) * Zi + (((2.0 * Zi) + (Zi + Zi)) + (Zi + Zi)) * Zr) + (((Zr + Zr) * Zi + (Zi + Zi) * Zr) + (Zr * Zi + Zi * Zr))) + (((Zr + Zr) * Zi + (Zi + Zi) * Zr) + (Zr * Zi + Zi * Zr)))) * di) * di + ((0.5 * ((((((2.0 * Zr) + (Zr + Zr)) + (Zr + Zr)) * Zr - (((2.0 * Zi) + (Zi + Zi)) + (Zi + Zi)) * Zi) + (((Zr + Zr) * Zr - (Zi + Zi) * Zi) + (Zr * Zr - Zi * Zi))) + (((Zr + Zr) * Zr - (Zi + Zi) * Zi) + (Zr * Zr - Zi * Zi)))) * di + (0.5 * ((((((2.0 * Zr) + (Zr + Zr)) + (Zr + Zr)) * Zi + (((2.0 * Zi) + (Zi + Zi)) + (Zi + Zi)) * Zr) + (((Zr + Zr) * Zi + (Zi + Zi) * Zr) + (Zr * Zi + Zi * Zr))) + (((Zr + Zr) * Zi + (Zi + Zi) * Zr) + (Zr * Zi + Zi * Zr)))) * dr) * dr)) + ((((0.16666666666666666 * ((((6.0 * Zr) + (((2.0 * Zr) + (Zr + Zr)) + (Zr + Zr))) + (((2.0 * Zr) + (Zr + Zr)) + (Zr + Zr))) + (((2.0 * Zr) + (Zr + Zr)) + (Zr + Zr)))) * dr - (0.16666666666666666 * ((((6.0 * Zi) + (((2.0 * Zi) + (Zi + Zi)) + (Zi + Zi))) + (((2.0 * Zi) + (Zi + Zi)) + (Zi + Zi))) + (((2.0 * Zi) + (Zi + Zi)) + (Zi + Zi)))) * di) * dr - ((0.16666666666666666 * ((((6.0 * Zr) + (((2.0 * Zr) + (Zr + Zr)) + (Zr + Zr))) + (((2.0 * Zr) + (Zr + Zr)) + (Zr + Zr))) + (((2.0 * Zr) + (Zr + Zr)) + (Zr + Zr)))) * di + (0.16666666666666666 * ((((6.0 * Zi) + (((2.0 * Zi) + (Zi + Zi)) + (Zi + Zi))) + (((2.0 * Zi) + (Zi + Zi)) + (Zi + Zi))) + (((2.0 * Zi) + (Zi + Zi)) + (Zi + Zi)))) * dr) * di) * di + (((0.16666666666666666 * ((((6.0 * Zr) + (((2.0 * Zr) + (Zr + Zr)) + (Zr + Zr))) + (((2.0 * Zr) + (Zr + Zr)) + (Zr + Zr))) + (((2.0 * Zr) + (Zr + Zr)) + (Zr + Zr)))) * dr - (0.16666666666666666 * ((((6.0 * Zi) + (((2.0 * Zi) + (Zi + Zi)) + (Zi + Zi))) + (((2.0 * Zi) + (Zi + Zi)) + (Zi + Zi))) + (((2.0 * Zi) + (Zi + Zi)) + (Zi + Zi)))) * di) * di + ((0.16666666666666666 * ((((6.0 * Zr) + (((2.0 * Zr) + (Zr + Zr)) + (Zr + Zr))) + (((2.0 * Zr) + (Zr + Zr)) + (Zr + Zr))) + (((2.0 * Zr) + (Zr + Zr)) + (Zr + Zr)))) * di + (0.16666666666666666 * ((((6.0 * Zi) + (((2.0 * Zi) + (Zi + Zi)) + (Zi + Zi))) + (((2.0 * Zi) + (Zi + Zi)) + (Zi + Zi))) + (((2.0 * Zi) + (Zi + Zi)) + (Zi + Zi)))) * dr) * dr) * dr)) + (((dr * dr - di * di) * dr - (dr * di + di * dr) * di) * di + ((dr * dr - di * di) * di + (dr * di + di * dr) * dr) * dr));
                        dr = dr_new; di = di_new;
                    }
