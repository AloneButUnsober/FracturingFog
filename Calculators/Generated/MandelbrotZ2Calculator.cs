...
// Generated: 2026-06-02 09:17:27 UTC
//
...
public sealed class MandelbrotZ2Calculator : IFractalCalculator, IDisposable
{
        ...
        Parallel.For(0, Height, new ParallelOptions { CancellationToken = ct }, y =>
        {
            ...
            else if (useSimd2Lane)
            {
                ...
                for (; x + 4 <= Width; x += 4)
                {
                    ...
                    Vector256<double> dv2re5 = Vector256.Create(1.0);
                    Vector256<double> dv2re6 = Avx.Add(dv2re3, dv2re5);
                    Vector256<double> drv_new = dv2re6;
                    Vector256<double> div_new = dv2im4;
                    ...
                    Vector256<double> p2re9 = Avx.Add(p2re7, er_v);
                    Vector256<double> p2im10 = Avx.Add(p2im8, ei_v);
                    Vector256<double> dr_new = p2re9;
                    Vector256<double> di_new = p2im10;
                            Vector256<double> keep = activeMask.AsDouble();
