...
// Generated: 2026-06-01 18:15:05 UTC
//
...
public sealed class MandelbrotZ3Calculator : IFractalCalculator, IDisposable
{
    ...
    private void IteratePixelScalar(double cr, double ci, uint[] buf, int idx)
    {
        ...
        for (; it < maxIt; it++)
        {
            ...
            double dr_new = (((3.0 * (zr * zr - zi * zi)) * dr - (3.0 * (zr * zi + zi * zr)) * di) + 1.0);
            double di_new = ((3.0 * (zr * zr - zi * zi)) * di + (3.0 * (zr * zi + zi * zr)) * dr);
    ...
    private void IterateLaneAvx2(Vector256<double> cr, Vector256<double> ci, uint[] buf, int idx)
    {
        ...
        for (int n = 0; n < maxIt; n++)
        {
            ...
            itCounts = Avx2.Add(itCounts, Avx2.And(oneL, activeMaskL));
                ...
                Vector256<double> d_re1 = Vector256.Create(3.0);
                ...
                Vector256<double> d_re4 = Avx.Multiply(d_re1, d_re2);
                Vector256<double> d_im5 = Avx.Multiply(d_re1, d_im3);
                Vector256<double> d_re6 = Fma.MultiplyAddNegated(d_im5, di, Avx.Multiply(d_re4, dr));
                Vector256<double> d_im7 = Fma.MultiplyAdd(d_re4, di, Avx.Multiply(d_im5, dr));
                Vector256<double> d_re8 = Vector256.Create(1.0);
                Vector256<double> d_re9 = Avx.Add(d_re6, d_re8);
                Vector256<double> dr_new = d_re9;
                Vector256<double> di_new = d_im7;
        ...
        if (useExtendedRef)
        {
            ...
            for (n = 0; n < maxIt; n++)
            {
                ...
                if (UseBla)
                {
                    ...
                    double cr = Cr, ci = Ci;
                    double Ar_new = (3.0 * (zr * zr - zi * zi));
                    double Ai_new = (3.0 * (zr * zi + zi * zr));
                    double Br_new = 1.0;
                    double Bi_new = 0.0;
            ...
            if (useSimdLane)
            {
                ...
                for (; x + 8 <= Width; x += 8)
                {
                    ...
                    for (int it = 0; it < refOrbitLen; it++)
                    {
                        ...
                        // Derivative
                        {
                    Vector512<double> dvre1 = Vector512.Create(3.0);
                    ...
                    Vector512<double> dvre4 = Avx512F.Multiply(dvre1, dvre2);
                    Vector512<double> dvim5 = Avx512F.Multiply(dvre1, dvim3);
                    Vector512<double> dvre6 = Avx512F.FusedMultiplyAddNegated(dvim5, div, Avx512F.Multiply(dvre4, drv));
                    Vector512<double> dvim7 = Avx512F.FusedMultiplyAdd(dvre4, div, Avx512F.Multiply(dvim5, drv));
                    Vector512<double> dvre8 = Vector512.Create(1.0);
                    Vector512<double> dvre9 = Avx512F.Add(dvre6, dvre8);
                    Vector512<double> drv_new = dvre9;
                    Vector512<double> div_new = dvim7;
                        ...
                        // δ
                        {
                    Vector512<double> pre1 = Vector512.Create(3.0);
                    ...
                    Vector512<double> pre4 = Avx512F.Multiply(pre1, pre2);
                    Vector512<double> pim5 = Avx512F.Multiply(pre1, pim3);
                    Vector512<double> pre6 = Avx512F.FusedMultiplyAddNegated(pim5, di, Avx512F.Multiply(pre4, dr));
                    Vector512<double> pim7 = Avx512F.FusedMultiplyAdd(pre4, di, Avx512F.Multiply(pim5, dr));
                    Vector512<double> pre8 = Avx512F.Add(er_v, pre6);
                    Vector512<double> pim9 = Avx512F.Add(ei_v, pim7);
                    Vector512<double> pre10 = Vector512.Create(0.5);
                    Vector512<double> pre11 = Vector512.Create(3.0);
                    ...
                    Vector512<double> pre15 = Avx512F.Multiply(pre11, pre13);
                    Vector512<double> pim16 = Avx512F.Multiply(pre11, pim14);
                    Vector512<double> pre17 = Avx512F.Multiply(pre10, pre15);
                    Vector512<double> pim18 = Avx512F.Multiply(pre10, pim16);
                    Vector512<double> pre19 = Avx512F.FusedMultiplyAddNegated(pim18, di, Avx512F.Multiply(pre17, dr));
                    Vector512<double> pim20 = Avx512F.FusedMultiplyAdd(pre17, di, Avx512F.Multiply(pim18, dr));
                    Vector512<double> pre21 = Avx512F.FusedMultiplyAddNegated(pim20, di, Avx512F.Multiply(pre19, dr));
                    Vector512<double> pim22 = Avx512F.FusedMultiplyAdd(pre19, di, Avx512F.Multiply(pim20, dr));
                    Vector512<double> pre23 = Avx512F.Add(pre8, pre21);
                    Vector512<double> pim24 = Avx512F.Add(pim9, pim22);
                    Vector512<double> pre25 = Avx512F.FusedMultiplyAddNegated(di, di, Avx512F.Multiply(dr, dr));
                    Vector512<double> pim26 = Avx512F.FusedMultiplyAdd(dr, di, Avx512F.Multiply(di, dr));
                    ...
                    Vector512<double> pre29 = Avx512F.Add(pre23, pre27);
                    Vector512<double> pim30 = Avx512F.Add(pim24, pim28);
                    Vector512<double> dr_new = pre29;
                    Vector512<double> di_new = pim30;
                            Vector512<double> keep = activeMask.AsDouble();
            ...
            for (; x < Width; x++)
            {
                ...
                double dr = 0.0, di = 0.0;     // δ
                {
                    ...
                    for (; it < refOrbitLen; it++)
                    {
                        ...
                        {
                    double drv_new = (((3.0 * (zr * zr - zi * zi)) * drv - (3.0 * (zr * zi + zi * zr)) * div) + 1.0);
                    double div_new = ((3.0 * (zr * zr - zi * zi)) * div + (3.0 * (zr * zi + zi * zr)) * drv);
                    ...
                    double dr_new = (((er + ((3.0 * (Zr * Zr - Zi * Zi)) * dr - (3.0 * (Zr * Zi + Zi * Zr)) * di)) + (((0.5 * (3.0 * (2.0 * Zr))) * dr - (0.5 * (3.0 * (2.0 * Zi))) * di) * dr - ((0.5 * (3.0 * (2.0 * Zr))) * di + (0.5 * (3.0 * (2.0 * Zi))) * dr) * di)) + ((dr * dr - di * di) * dr - (dr * di + di * dr) * di));
                    double di_new = (((ei + ((3.0 * (Zr * Zr - Zi * Zi)) * di + (3.0 * (Zr * Zi + Zi * Zr)) * dr)) + (((0.5 * (3.0 * (2.0 * Zr))) * dr - (0.5 * (3.0 * (2.0 * Zi))) * di) * di + ((0.5 * (3.0 * (2.0 * Zr))) * di + (0.5 * (3.0 * (2.0 * Zi))) * dr) * dr)) + ((dr * dr - di * di) * di + (dr * di + di * dr) * dr));
                        dr = dr_new; di = di_new;
                    }
