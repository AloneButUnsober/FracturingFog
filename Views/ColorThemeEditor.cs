...
namespace FracturingFog.Views
{
    public sealed class ColorThemeEditor : Form
    {
        ...
        private void ExportCSharp()
        {
            ...
            string className = ColorThemeCsExporter.MakeClassName(data.Name);
            ...
            try
            {
                string code = ColorThemeCsExporter.BuildCSharpSource(data, className);
        ...
        // BuildCSharpSource + MakeClassName + the Flt/Dbl/Quote/NullableInt
        // helpers used to live here. They were lifted into
        // Models/ColorThemeCsExporter.cs so HostColorThemeService (Avalonia)
        // and this legacy editor share one emitter. See task #42.
