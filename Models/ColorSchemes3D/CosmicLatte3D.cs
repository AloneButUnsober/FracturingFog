...
namespace FracturingFog.Models
{
    ...
    /// </summary>
    public class CosmicLatte3DMap : GradientColorMap, IColorMap
    {
        public static string Name => "Cosmic Latte 3D";
        public static string Category => "3D Relief";
        public static string Description => "Cosmic Latte gradient as a 3D Phong relief.";
        ...
        private const float CycleSpeed = 0.025f;
