...
namespace FracturingFog.Models
{
    ...
    /// </summary>
    public class Tropical3DMap : CyclingGradientColorMap, IColorMap
    {
        public static string Name => "Tropical 3D";
        public static string Category => "3D Relief";
        public static string Description => "Tropical gradient as a 3D Phong relief.";
        ...
        private const float CycleSpeed = 0.022f;
