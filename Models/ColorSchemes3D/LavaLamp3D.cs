...
namespace FracturingFog.Models
{
    ...
    /// </summary>
    public class LavaLamp3DMap : GradientColorMap, IColorMap
    {
        public static string Name => "Laval Lamp 3D";
        public static string Category => "3D Relief";
        public static string Description => "Laval Lamp gradient as a 3D Phong relief.";
        ...
        private const float CycleSpeed = 0.018f;
