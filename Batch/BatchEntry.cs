...
namespace FracturingFog.Batch
{
    public static class BatchEntry
    {
        ...
        private static void PrintUsage()
        {
            ...
            Console.WriteLine("                              BicomplexMandelbrot|Coquaternion|DualOrbitVolume|Dla|");
            ...
            Console.WriteLine("  --relight-ao F              Relight AO strength 0..4 (implies --relight).");
            Console.WriteLine("  --relight-ambient F         Relight flat ambient 0..4 (implies --relight).");
            ...
            Console.WriteLine();
            Console.WriteLine("Lights (N = 1, 2 or 3). Directional fields apply to every 3D family + the 2D");
            Console.WriteLine("shade path and do NOT force relief; only point/spot type + pos/range/cone imply --relief-raymarch:");
            Console.WriteLine("  --lightN-type T             directional | point | spot. Point/spot add falloff (imply --relief-raymarch).");
            ...
            Console.WriteLine("  --lightN-pos \"x,y,z\"        World position (point / spot; implies --relief-raymarch).");
            Console.WriteLine("  --lightN-range F            Soft cutoff 0..100 (0 = pure inverse-square; implies --relief-raymarch).");
            Console.WriteLine("  --lightN-cone \"inner,outer\" Spot cone half-angles in degrees (implies --relief-raymarch).");
