...
public static class AstSimplifier
{
    ...
    private static AstNode SimplifyOnce(AstNode node) => node switch
    {
        ...
        Floor fl => new Floor(Simplify(fl.Operand)),
        Round rd => new Round(Simplify(rd.Operand)),
        Ceil ce  => new Ceil(Simplify(ce.Operand)),
        Trunc tr => new Trunc(Simplify(tr.Operand)),
        Fract fr => new Fract(Simplify(fr.Operand)),
        Sign sg  => new Sign(Simplify(sg.Operand)),
        ...
        Acos ac1  => new Acos(Simplify(ac1.Operand)),
        Atan at1  => new Atan(Simplify(at1.Operand)),
        Asinh ah1 => new Asinh(Simplify(ah1.Operand)),
        Acosh ch1 => new Acosh(Simplify(ch1.Operand)),
        Atanh th1 => new Atanh(Simplify(th1.Operand)),
        ...
        PowC pc => new PowC(Simplify(pc.Base), Simplify(pc.Exp)),
