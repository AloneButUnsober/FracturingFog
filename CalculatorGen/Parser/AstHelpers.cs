...
public static class AstHelpers
{
    ...
    public static bool Contains<T>(AstNode node) where T : AstNode => node switch
    {
        ...
        PowC pc => Contains<T>(pc.Base)  || Contains<T>(pc.Exp),
        Div d  => Contains<T>(d.Left)   || Contains<T>(d.Right),
        Conj c => Contains<T>(c.Operand),
        Folded f => Contains<T>(f.Operand),
        Floor fl => Contains<T>(fl.Operand),
        Round rd => Contains<T>(rd.Operand),
        Ceil ce  => Contains<T>(ce.Operand),
        Trunc tr => Contains<T>(tr.Operand),
        Fract fr => Contains<T>(fr.Operand),
        Sign sg  => Contains<T>(sg.Operand),
        ...
        Acos ac1  => Contains<T>(ac1.Operand),
        Atan at1  => Contains<T>(at1.Operand),
        Asinh ah1 => Contains<T>(ah1.Operand),
        Acosh ch1 => Contains<T>(ch1.Operand),
        Atanh th1 => Contains<T>(th1.Operand),
