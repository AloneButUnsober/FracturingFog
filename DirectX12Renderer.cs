...
//        _device.SerializeRootSignature(rootDesc, out var rsBlob, out var erBlob); //  .SerializeVersionedRootSignature(rootDesc);
...
//        using var vsBlob = Vortice.D3DCompiler.Compiler.Compile(
//            hlsl, "VS", "vs_5_0");
//        using var psBlob = Vortice.D3DCompiler.Compiler.Compile(
//            hlsl, "PS", "ps_5_0");
...
//            VertexShader = new ShaderBytecode(vsBlob.GetBytes()),
//            PixelShader = new ShaderBytecode(psBlob.GetBytes()),
...
//                    Texture2D = new Tex2DSrv { MipLevels = 1 },
//                },
