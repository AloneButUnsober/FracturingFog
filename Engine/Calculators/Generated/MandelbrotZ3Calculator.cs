...
// Generated: 2026-06-20 11:10:43 UTC
//
            ...
            do
            {
                ...
                for (n = 0; n < maxIt; n++)
                {
                    ...
                    if (UseBla)
                    {
                        ...
                        double cr = Cr, ci = Ci;
                    double Ar_new = (((zr + zr) * zr - (zi + zi) * zi) + (zr * zr - zi * zi));
                    double Ai_new = (((zr + zr) * zi + (zi + zi) * zr) + (zr * zi + zi * zr));
                    double Br_new = 1.0;
                    double Bi_new = 0.0;
                    ...
                    {
                QD zr_q_new = (((zr_q * zr_q - zi_q * zi_q) * zr_q - (zr_q * zi_q + zi_q * zr_q) * zi_q) + CrQd);
                QD zi_q_new = (((zr_q * zr_q - zi_q * zi_q) * zi_q + (zr_q * zi_q + zi_q * zr_q) * zr_q) + CiQd);
...
#pragma warning restore CS0219
        ...
        else if (SaEnabled && UseSa && refOrbitLen > 8)
        {
            ...
            for (n = 0; n < refOrbitLen; n++)
            {
                ...
                double SrNew1 = 3.0 * (Zp2Re * Sr1 - Zp2Im * Si1) + 1.0;
                double SiNew1 = 3.0 * (Zp2Re * Si1 + Zp2Im * Sr1);
                double SrNew2 = 3.0 * (Zp2Re * Sr2 - Zp2Im * Si2) + 3.0 * (Zp1Re * dPow2_2_Re - Zp1Im * dPow2_2_Im);
                double SiNew2 = 3.0 * (Zp2Re * Si2 + Zp2Im * Sr2) + 3.0 * (Zp1Re * dPow2_2_Im + Zp1Im * dPow2_2_Re);
                double SrNew3 = 3.0 * (Zp2Re * Sr3 - Zp2Im * Si3) + 3.0 * (Zp1Re * dPow2_3_Re - Zp1Im * dPow2_3_Im) + dPow3_3_Re;
                double SiNew3 = 3.0 * (Zp2Re * Si3 + Zp2Im * Sr3) + 3.0 * (Zp1Re * dPow2_3_Im + Zp1Im * dPow2_3_Re) + dPow3_3_Im;
                double SrNew4 = 3.0 * (Zp2Re * Sr4 - Zp2Im * Si4) + 3.0 * (Zp1Re * dPow2_4_Re - Zp1Im * dPow2_4_Im) + dPow3_4_Re;
                double SiNew4 = 3.0 * (Zp2Re * Si4 + Zp2Im * Sr4) + 3.0 * (Zp1Re * dPow2_4_Im + Zp1Im * dPow2_4_Re) + dPow3_4_Im;
                double SrNew5 = 3.0 * (Zp2Re * Sr5 - Zp2Im * Si5) + 3.0 * (Zp1Re * dPow2_5_Re - Zp1Im * dPow2_5_Im) + dPow3_5_Re;
                double SiNew5 = 3.0 * (Zp2Re * Si5 + Zp2Im * Sr5) + 3.0 * (Zp1Re * dPow2_5_Im + Zp1Im * dPow2_5_Re) + dPow3_5_Im;
                double SrNew6 = 3.0 * (Zp2Re * Sr6 - Zp2Im * Si6) + 3.0 * (Zp1Re * dPow2_6_Re - Zp1Im * dPow2_6_Im) + dPow3_6_Re;
                double SiNew6 = 3.0 * (Zp2Re * Si6 + Zp2Im * Sr6) + 3.0 * (Zp1Re * dPow2_6_Im + Zp1Im * dPow2_6_Re) + dPow3_6_Im;
                double SrNew7 = 3.0 * (Zp2Re * Sr7 - Zp2Im * Si7) + 3.0 * (Zp1Re * dPow2_7_Re - Zp1Im * dPow2_7_Im) + dPow3_7_Re;
                double SiNew7 = 3.0 * (Zp2Re * Si7 + Zp2Im * Sr7) + 3.0 * (Zp1Re * dPow2_7_Im + Zp1Im * dPow2_7_Re) + dPow3_7_Im;
                double SrNew8 = 3.0 * (Zp2Re * Sr8 - Zp2Im * Si8) + 3.0 * (Zp1Re * dPow2_8_Re - Zp1Im * dPow2_8_Im) + dPow3_8_Re;
                double SiNew8 = 3.0 * (Zp2Re * Si8 + Zp2Im * Sr8) + 3.0 * (Zp1Re * dPow2_8_Im + Zp1Im * dPow2_8_Re) + dPow3_8_Im;
                double SrNew9 = 3.0 * (Zp2Re * Sr9 - Zp2Im * Si9) + 3.0 * (Zp1Re * dPow2_9_Re - Zp1Im * dPow2_9_Im) + dPow3_9_Re;
                double SiNew9 = 3.0 * (Zp2Re * Si9 + Zp2Im * Sr9) + 3.0 * (Zp1Re * dPow2_9_Im + Zp1Im * dPow2_9_Re) + dPow3_9_Im;
                double SrNew10 = 3.0 * (Zp2Re * Sr10 - Zp2Im * Si10) + 3.0 * (Zp1Re * dPow2_10_Re - Zp1Im * dPow2_10_Im) + dPow3_10_Re;
                double SiNew10 = 3.0 * (Zp2Re * Si10 + Zp2Im * Sr10) + 3.0 * (Zp1Re * dPow2_10_Im + Zp1Im * dPow2_10_Re) + dPow3_10_Im;
                double SrNew11 = 3.0 * (Zp2Re * Sr11 - Zp2Im * Si11) + 3.0 * (Zp1Re * dPow2_11_Re - Zp1Im * dPow2_11_Im) + dPow3_11_Re;
                double SiNew11 = 3.0 * (Zp2Re * Si11 + Zp2Im * Sr11) + 3.0 * (Zp1Re * dPow2_11_Im + Zp1Im * dPow2_11_Re) + dPow3_11_Im;
                double SrNew12 = 3.0 * (Zp2Re * Sr12 - Zp2Im * Si12) + 3.0 * (Zp1Re * dPow2_12_Re - Zp1Im * dPow2_12_Im) + dPow3_12_Re;
                double SiNew12 = 3.0 * (Zp2Re * Si12 + Zp2Im * Sr12) + 3.0 * (Zp1Re * dPow2_12_Im + Zp1Im * dPow2_12_Re) + dPow3_12_Im;
                double SrNew13 = 3.0 * (Zp2Re * Sr13 - Zp2Im * Si13) + 3.0 * (Zp1Re * dPow2_13_Re - Zp1Im * dPow2_13_Im) + dPow3_13_Re;
                double SiNew13 = 3.0 * (Zp2Re * Si13 + Zp2Im * Sr13) + 3.0 * (Zp1Re * dPow2_13_Im + Zp1Im * dPow2_13_Re) + dPow3_13_Im;
                double SrNew14 = 3.0 * (Zp2Re * Sr14 - Zp2Im * Si14) + 3.0 * (Zp1Re * dPow2_14_Re - Zp1Im * dPow2_14_Im) + dPow3_14_Re;
                double SiNew14 = 3.0 * (Zp2Re * Si14 + Zp2Im * Sr14) + 3.0 * (Zp1Re * dPow2_14_Im + Zp1Im * dPow2_14_Re) + dPow3_14_Im;
                double SrNew15 = 3.0 * (Zp2Re * Sr15 - Zp2Im * Si15) + 3.0 * (Zp1Re * dPow2_15_Re - Zp1Im * dPow2_15_Im) + dPow3_15_Re;
                double SiNew15 = 3.0 * (Zp2Re * Si15 + Zp2Im * Sr15) + 3.0 * (Zp1Re * dPow2_15_Im + Zp1Im * dPow2_15_Re) + dPow3_15_Im;
                double SrNew16 = 3.0 * (Zp2Re * Sr16 - Zp2Im * Si16) + 3.0 * (Zp1Re * dPow2_16_Re - Zp1Im * dPow2_16_Im) + dPow3_16_Re;
                double SiNew16 = 3.0 * (Zp2Re * Si16 + Zp2Im * Sr16) + 3.0 * (Zp1Re * dPow2_16_Im + Zp1Im * dPow2_16_Re) + dPow3_16_Im;
        ...
        Parallel.For(0, Height, new ParallelOptions { CancellationToken = ct }, y =>
        {
            ...
            if (useSimd512Lane)
            {
                ...
                for (; x + 8 <= Width; x += 8)
                {
                    ...
                    Vector512<double> dvre9 = Avx512F.FusedMultiplyAddNegated(dvim8, div, Avx512F.Multiply(dvre7, drv));
                    Vector512<double> dvim10 = Avx512F.FusedMultiplyAdd(dvre7, div, Avx512F.Multiply(dvim8, drv));
                    Vector512<double> dvre11 = Vector512.Create(1.0);
                    Vector512<double> dvre12 = Avx512F.Add(dvre9, dvre11);
                    Vector512<double> drv_new = dvre12;
                    Vector512<double> div_new = dvim10;
            ...
            else if (useSimd2Lane)
            {
                ...
                for (; x + 4 <= Width; x += 4)
                {
                    ...
                    Vector256<double> dv2re9 = Fma.MultiplyAddNegated(dv2im8, div, Avx.Multiply(dv2re7, drv));
                    Vector256<double> dv2im10 = Fma.MultiplyAdd(dv2re7, div, Avx.Multiply(dv2im8, drv));
                    Vector256<double> dv2re11 = Vector256.Create(1.0);
                    Vector256<double> dv2re12 = Avx.Add(dv2re9, dv2re11);
                    Vector256<double> drv_new = dv2re12;
                    Vector256<double> div_new = dv2im10;
                    ...
                    Vector256<double> p2re9 = Fma.MultiplyAddNegated(p2im8, di, Avx.Multiply(p2re7, dr));
                    Vector256<double> p2im10 = Fma.MultiplyAdd(p2re7, di, Avx.Multiply(p2im8, dr));
                    Vector256<double> p2re11 = Vector256.Create(0.5);
                    Vector256<double> p2re12 = Vector256.Create(2.0);
                    Vector256<double> p2re13 = Avx.Multiply(p2re12, Zr_v);
                    Vector256<double> p2im14 = Avx.Multiply(p2re12, Zi_v);
                    Vector256<double> p2re15 = Avx.Add(Zr_v, Zr_v);
                    Vector256<double> p2im16 = Avx.Add(Zi_v, Zi_v);
                    Vector256<double> p2re17 = Avx.Add(p2re13, p2re15);
                    Vector256<double> p2im18 = Avx.Add(p2im14, p2im16);
                    Vector256<double> p2re19 = Avx.Add(Zr_v, Zr_v);
                    Vector256<double> p2im20 = Avx.Add(Zi_v, Zi_v);
                    Vector256<double> p2re21 = Avx.Add(p2re17, p2re19);
                    Vector256<double> p2im22 = Avx.Add(p2im18, p2im20);
                    Vector256<double> p2re23 = Avx.Multiply(p2re11, p2re21);
                    Vector256<double> p2im24 = Avx.Multiply(p2re11, p2im22);
                    Vector256<double> p2re25 = Fma.MultiplyAddNegated(p2im24, di, Avx.Multiply(p2re23, dr));
                    Vector256<double> p2im26 = Fma.MultiplyAdd(p2re23, di, Avx.Multiply(p2im24, dr));
                    ...
                    Vector256<double> p2re29 = Avx.Add(p2re9, p2re27);
                    Vector256<double> p2im30 = Avx.Add(p2im10, p2im28);
                    Vector256<double> p2re31 = Fma.MultiplyAddNegated(di, di, Avx.Multiply(dr, dr));
                    Vector256<double> p2im32 = Fma.MultiplyAdd(dr, di, Avx.Multiply(di, dr));
                    Vector256<double> p2re33 = Fma.MultiplyAddNegated(p2im32, di, Avx.Multiply(p2re31, dr));
                    Vector256<double> p2im34 = Fma.MultiplyAdd(p2re31, di, Avx.Multiply(p2im32, dr));
                    Vector256<double> p2re35 = Avx.Add(p2re29, p2re33);
                    Vector256<double> p2im36 = Avx.Add(p2im30, p2im34);
                    Vector256<double> p2re37 = Avx.Add(p2re35, er_v);
                    Vector256<double> p2im38 = Avx.Add(p2im36, ei_v);
                    Vector256<double> dr_new = p2re37;
                    Vector256<double> di_new = p2im38;
                            Vector256<double> keep = activeMask.AsDouble();
            ...
            for (; x < Width; x++)
            {
                ...
                double dr = 0.0, di = 0.0;     // δ
                {
                    ...
                    for (; it < refOrbitLen; it++)
                    {
                        ...
                        {
                    double drv_new = (((((zr + zr) * zr - (zi + zi) * zi) + (zr * zr - zi * zi)) * drv - (((zr + zr) * zi + (zi + zi) * zr) + (zr * zi + zi * zr)) * div) + 1.0);
                    double div_new = ((((zr + zr) * zr - (zi + zi) * zi) + (zr * zr - zi * zi)) * div + (((zr + zr) * zi + (zi + zi) * zr) + (zr * zi + zi * zr)) * drv);
        ...
        for (; it < maxIt; it++)
        {
            ...
            }
            {
                ...
                drv = drv_new; div = div_new;
                    ...
                    DD zr_dd_new = (((zr_dd * zr_dd - zi_dd * zi_dd) * zr_dd - (zr_dd * zi_dd + zi_dd * zr_dd) * zi_dd) + cr_dd);
                    DD zi_dd_new = (((zr_dd * zr_dd - zi_dd * zi_dd) * zi_dd + (zr_dd * zi_dd + zi_dd * zr_dd) * zr_dd) + ci_dd);
        ...
        for (; it < maxIt; it++)
        {
            ...
            }
            {
                ...
                drv = drv_new; div = div_new;
                    ...
                    QD zr_q_new = (((zr_q * zr_q - zi_q * zi_q) * zr_q - (zr_q * zi_q + zi_q * zr_q) * zi_q) + cr_q);
                    QD zi_q_new = (((zr_q * zr_q - zi_q * zi_q) * zi_q + (zr_q * zi_q + zi_q * zr_q) * zr_q) + ci_q);
            zr_q = zr_q_new; zi_q = zi_q_new;
        }
        return ColorForDd(it, finalZr, finalZi, finalZMag2, drv, div, maxIt, bufIdx);
    }
    ...
    private void ComputePixel4Dd4Direct(DD4 cr_dd4, DD4 ci_dd4, int maxIt, int bufIdxBase)
    {
        ...
        for (int it = 0; it < maxIt; it++)
        {
            ...
            {
                    DD4 zr_dd4_new = (((zr_dd4 * zr_dd4 - zi_dd4 * zi_dd4) * zr_dd4 - (zr_dd4 * zi_dd4 + zi_dd4 * zr_dd4) * zi_dd4) + cr_dd4);
                    DD4 zi_dd4_new = (((zr_dd4 * zr_dd4 - zi_dd4 * zi_dd4) * zi_dd4 + (zr_dd4 * zi_dd4 + zi_dd4 * zr_dd4) * zr_dd4) + ci_dd4);
                zr_dd4 = zr_dd4_new;
                zi_dd4 = zi_dd4_new;
            }
        }
