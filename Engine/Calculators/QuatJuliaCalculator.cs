    ...
    public void Calculate(CancellationToken ct = default)
    {
        ...
        Parallel.For(0, height, new ParallelOptions { CancellationToken = ct }, y =>
        {
                          ...
                          out float hr, out float hg, out float hb)
            {
                ...
                {
                    double dist = QuatJuliaDE(sx, sy, sz, sliceW, cx, cy, cz, cw, bailout2, deIter);
                ...
                double hn = eps * 2;
                double sn0 = QuatJuliaDE(sx + hn, sy, sz, sliceW, cx, cy, cz, cw, bailout2, deIter)
                           - QuatJuliaDE(sx - hn, sy, sz, sliceW, cx, cy, cz, cw, bailout2, deIter);
                double sn1 = QuatJuliaDE(sx, sy + hn, sz, sliceW, cx, cy, cz, cw, bailout2, deIter)
                           - QuatJuliaDE(sx, sy - hn, sz, sliceW, cx, cy, cz, cw, bailout2, deIter);
                double sn2 = QuatJuliaDE(sx, sy, sz + hn, sliceW, cx, cy, cz, cw, bailout2, deIter)
                           - QuatJuliaDE(sx, sy, sz - hn, sliceW, cx, cy, cz, cw, bailout2, deIter);
