        ...
        Index1D idx, ArrayView<uint> output, GpuRaymarchParams r, GpuShadingParams sp, MengerGpuParams p, ArrayView<uint> palette)
    {
        ...
        if (spL.ShadowSteps > 0)
        {
            if ((spL.ShadowLightMask & 0x1) != 0 && spL.L1I > 0)
                sh1 = SoftShadow(ox2, oy2, oz2, spL.L1X, spL.L1Y, spL.L1Z, r.Eps, spL.ShadowTMax, spL.ShadowSoftK, spL.ShadowSteps, p);
            if ((spL.ShadowLightMask & 0x2) != 0 && spL.L2I > 0)
                sh2 = SoftShadow(ox2, oy2, oz2, spL.L2X, spL.L2Y, spL.L2Z, r.Eps, spL.ShadowTMax, spL.ShadowSoftK, spL.ShadowSteps, p);
            if ((spL.ShadowLightMask & 0x4) != 0 && spL.L3I > 0)
                sh3 = SoftShadow(ox2, oy2, oz2, spL.L3X, spL.L3Y, spL.L3Z, r.Eps, spL.ShadowTMax, spL.ShadowSoftK, spL.ShadowSteps, p);
        }
