...
namespace FracturingFog.Rendering
{
    ...
    public sealed partial class FractalRenderHost : IFractalRenderHost
    {
        ...
        private TranscendentalJuliaCalculator _transcendentalCalculator;
        ...
        private SemigroupJuliaCalculator _semigroupCalculator;
        ...
        public FractalRenderHost(IFractalRenderer renderer, FractalViewState state, int width, int height, IColorMap initialColorMap)
        {
            ...
            _transcendentalCalculator = new TranscendentalJuliaCalculator(w, h);
            ...
            _semigroupCalculator = new SemigroupJuliaCalculator(w, h);
            ...
            if (initialColorMap != null)
            {
                ...
                _transcendentalCalculator.ColorMap = initialColorMap;
                ...
                _semigroupCalculator.ColorMap = initialColorMap;
        ...
        public IColorMap ColorMap
        {
            ...
            set
            {
                ...
                _transcendentalCalculator.ColorMap = value;
                ...
                _semigroupCalculator.ColorMap = value;
        ...
        public void ApplyView(int maxIters = 0)
        {
            ...
            // root, floor the iteration cap at the MEASURED near-parabolic budget
            // (ParabolicImplosionMath.RecommendedIterations): the cusp needs ~10/approach
            // (the parabolic 1/n crawl), higher-q roots the milder ~30/√approach. A floor,
            // not a blind multiply — the base cap already covers the shallow frames.
        ...
        public static bool SupportsHiResReliefField(FractalType type) => type switch
        {
            ...
            FractalType.SemigroupJulia => true,
        ...
        public void Resize(int width, int height)
        {
            ...
            _transcendentalCalculator.Resize(w, h);
            ...
            _semigroupCalculator.Resize(w, h);
        ...
        private void SyncAltStateFromMandel(IFractalCalculator alt)
        {
            ...
            switch (alt)
            {
                ...
                case SemigroupJuliaCalculator sj: sj.FractalParameters = ViewState.FractalParameters; break;
                ...
                case TranscendentalJuliaCalculator tj:
                    tj.FractalParameters = ViewState.FractalParameters;
                    tj.InteriorAlpha = ViewState.FractalParameters?.InteriorAlpha ?? 255;
                    break;
        ...
        private IFractalCalculator? SelectAltCalculatorByType(FractalType type) => type switch
        {
            ...
            FractalType.TranscendentalJulia => _transcendentalCalculator,
            ...
            FractalType.SemigroupJulia => _semigroupCalculator,
